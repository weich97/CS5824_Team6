...
## Results
The following figures show a training data sample and a prediction data sample, respectively. However, this training data sample cannot be compared directly to the prediction data sample as they are not from the same distribution. We are not sure of why the paper uses such a way to present the results.
