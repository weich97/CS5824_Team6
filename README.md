...
### Divergence Graphs
lr=0.0005, lambda=0.02  |  lr=0.00005, lambda=0.02  |  lr=0.0005, lambda=0.2  |  with singularity
:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:
<img src="results/lr_0005_lambda_02.PNG" width="200" height="200">  |  <img src="results/lr_00005_lambda_02.PNG" width="200" height="200">  |  <img src="results/lr_0005_lambda_2.PNG" width="200" height="200">  |  <img src="results/singularity.PNG" width="200" height="200">
