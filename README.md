...
The following figure shows the effect of the tuning factor lambda over the convergence. A moderate number of lambda is preferred as it makes the convergence faster and better.
